...
class AddressVC: UIView {
    ...
    init(frame: CGRect, location: Location) {
        ...
        let addressImageOrigin = CGPoint(x: 0, y: 5)
        ...
        let addressNameOrigin = CGPoint(x: center.x - ((frame.width * 0.6)/2), y: (frame.height/2) + (frame.height * 0.10) + 5)
        ...
        let addressLocationOrigin = CGPoint(x: center.x - ((frame.width * 0.6)/2), y: (frame.height/2) + (frame.height * 0.10) + (frame.height * 0.10) + 10)
